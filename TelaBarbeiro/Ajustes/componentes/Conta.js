...
const Conta = () => {
    ...
    const [editNomeBarbearia, setEditNomeBarbearia] = useState(null);
            ...
            <ScrollView>
                ...
                <View style={estilos.formulario}>
                    ...
                    <View style={estilos.inputContainer}>
                        ...
                        <Image
                            source={barber}
                            style={{ height: 20, width: 20, position: "absolute", top: 21, left: 13 }} />

                        <TextInput
                            style={estilos.textInput}
                            placeholder="Nome da Barbearia"
                            placeholderTextColor="white"
                            value={userData.nomeBarbearia}
                            editable={editNomeBarbearia}
                            onFocus={() => setEditNomeBarbearia(true)} 
                            onBlur={() => setEditNomeBarbearia(false)} 
                            onChangeText={(text) => setUserData({ ...userData, nomeBarbearia: text })}
                            />
                    ...
                    <View style={estilos.inputContainer}>
                        ...
                        <TextInput style={estilos.textInput}
                            ...
                            value={userData.cnpj}
                            editable={editCnpj}
                            onFocus={() => setEditCnpj(true)} 
                            onBlur={() => setEditCnpj(false)} 
